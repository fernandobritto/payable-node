...
import { CustomerChangedName } from 'src/@core/events/domain/events/domain-events/customer-changed-name.event'
import { CustomerCreated } from 'src/@core/events/domain/events/domain-events/customer-created.event'
