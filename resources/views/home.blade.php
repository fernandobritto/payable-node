                ...
                <div class="card-body">
                    <div class="card-deck">
                        <div class="col-sm-4">
                           ...
                           <img src="img/img_home.png" alt="" width="100%" height="250px">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('files') }}" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Ver lista de CSVs</a>
                                <a href="#" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Criar um novo CSV</a>
                                <a href="#" class="btn btn-secondary btn-lg active" role="button" aria-pressed="true">Fazer Upload</a><br>
